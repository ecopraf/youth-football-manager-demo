export function setupLayout() {
  ...
  // Badge Demo con stile verde (stesso del mission panel)
  const demoBadge = isDemoSession ? '<span id="yfmMissionBadge" onclick="window.demoManager && window.demoManager.toggleMissionPanel()" style="background:white;color:#27AE60;padding:8px 18px;border-radius:25px;font-size:13px;font-weight:700;cursor:pointer;margin-left:8px;display:inline-flex;align-items:center;gap:8px;box-shadow:0 4px 15px rgba(0,0,0,0.15),0 2px 4px rgba(39,174,96,0.2),inset 0 1px 2px rgba(255,255,255,0.8);border:2px solid #27AE60;text-shadow:0 1px 1px rgba(39,174,96,0.2);">🌱 Demo <span id="demoProgress">0%</span></span>' : '';
  ...
  style.textContent = `
    ...
    #yfmMissionBadge:hover { transform: translateY(-2px) scale(1.03); box-shadow: 0 8px 25px rgba(39,174,96,0.4),0 4px 8px rgba(0,0,0,0.1),inset 0 1px 2px rgba(255,255,255,0.8); }
    #demoProgress {
