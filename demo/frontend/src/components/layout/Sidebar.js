export function setupLayout() {
  ...
  // Badge YFM per missioni (accanto al selettore squadre)
  const yfmMissionBadge = isDemoSession ? '<button id="yfmMissionBadge" onclick="window.demoManager && window.demoManager.toggleMissionPanel()" style="background:linear-gradient(135deg,#667eea,#764ba2);color:white;padding:6px 14px;border-radius:10px;font-size:12px;font-weight:600;border:none;cursor:pointer;margin-left:8px;">YFM</button>' : '';
