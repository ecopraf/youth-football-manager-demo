...
const DEMO_PARTITE = [
  ...
  { id: 'm004', avversario: 'Milan Youth', luogo: 'Trasferta', data_ora: '2026-06-13T15:00:00', competizione: 'Coppa Primavera', stato: 'Terminata', gol_casa: 2, gol_trasferta: 2, giornata: 1, tipo_evento: 'coppa', dettaglio_competizione: 'QF', badge_avversario: '#FF0000', note_avversario: 'Pressing alto nei primi 20 minuti, poi calano. Il n.10 è il regista, da marcare stretto. Calci piazzati pericolosi.',
    presenze: ['c001','c002','c003','c004','c005','c006','c007','c008','c009','c010','c011','c012','c013','c015','c016','c017','c018','c019','c020'] },
  { id: 'm005', avversario: 'Juventus Academy', luogo: 'Casa', data_ora: '2026-06-06T15:00:00', competizione: 'Campionato Primavera', stato: 'Terminata', gol_casa: 4, gol_trasferta: 0, giornata: 13, tipo_evento: 'campionato', dettaglio_competizione: 'G.13', badge_avversario: '#000000',
    presenze: ['c001','c002','c003','c004','c005','c006','c007','c008','c009','c010','c011','c012','c013','c015','c017','c018','c020'] },
  { id: 'm006', avversario: 'Napoli Academy', luogo: 'Trasferta', data_ora: '2026-05-30T15:00:00', competizione: 'Torneo Infiorata', stato: 'Terminata', gol_casa: 1, gol_trasferta: 2, giornata: 1, tipo_evento: 'torneo', dettaglio_competizione: 'Torneo Infiorata G.01', badge_avversario: '#1E90FF', note_avversario: 'Giocano bene a terra, possesso palla. Vulnerabili sulle ripartenze. Il portiere esce spesso: provare pallonetti da fuori area.',
    presenze: ['c001','c002','c003','c004','c005','c006','c007','c008','c009','c010','c011','c013','c015','c016','c017','c018','c019','c020'] },
...
const DEMO_CALCIATORI_U17 = [
  ...
  { id: 'u006', nome: 'Andrea', cognome: 'Ricci', data_nascita: '2011-03-05', numero_maglia: 6, ruolo: 'Centrocampista', stato: 'Attivo', presenze: 9, gol: 1, assist: 2 },
...
const DEMO_CALCIATORI = [
  { id: 'c001', nome: 'Alessandro', cognome: 'Rossi', data_nascita: '2010-03-15', numero_maglia: 1, ruolo: 'Portiere', stato: 'Attivo', presenze: 10, gol: 0, assist: 0, tipo_documento: 'Carta Identità', numero_documento: 'AB1234567', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-001-2024', data_visita_medica: '2026-01-15' },
  { id: 'c002', nome: 'Luca', cognome: 'Bianchi', data_nascita: '2010-01-20', numero_maglia: 2, ruolo: 'Difensore', stato: 'Attivo', presenze: 14, gol: 1, assist: 2, tipo_documento: 'Carta Identità', numero_documento: 'AB2345678', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-002-2024', data_visita_medica: '2026-02-10' },
  { id: 'c003', nome: 'Matteo', cognome: 'Verdi', data_nascita: '2010-05-10', numero_maglia: 3, ruolo: 'Difensore', stato: 'Attivo', presenze: 14, gol: 0, assist: 1, tipo_documento: 'Passaporto', numero_documento: 'PA3456789', rilasciato_da: 'Questura di Roma', matricola_figc: 'FIGC-003-2024', data_visita_medica: '2026-03-20' },
  { id: 'c004', nome: 'Francesco', cognome: 'Gialli', data_nascita: '2010-02-28', numero_maglia: 4, ruolo: 'Difensore', stato: 'Attivo', presenze: 11, gol: 0, assist: 0, tipo_documento: 'Carta Identità', numero_documento: 'AB4567890', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-004-2024', data_visita_medica: '2025-12-01' },
  { id: 'c005', nome: 'Andrea', cognome: 'Neri', data_nascita: '2010-07-14', numero_maglia: 5, ruolo: 'Centrocampista', stato: 'Attivo', presenze: 13, gol: 2, assist: 4, tipo_documento: 'Carta Identità', numero_documento: 'AB5678901', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-005-2024', data_visita_medica: '2026-04-10' },
  { id: 'c006', nome: 'Davide', cognome: 'Blu', data_nascita: '2010-04-05', numero_maglia: 6, ruolo: 'Centrocampista', stato: 'Attivo', presenze: 10, gol: 1, assist: 1, tipo_documento: 'Carta Identità', numero_documento: 'AB6789012', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-006-2024', data_visita_medica: '2026-05-15' },
  { id: 'c007', nome: 'Simone', cognome: 'Arancioni', data_nascita: '2010-06-22', numero_maglia: 7, ruolo: 'Attaccante', stato: 'Attivo', presenze: 13, gol: 9, assist: 8, tipo_documento: 'Carta Identità', numero_documento: 'AB7890123', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-007-2024', data_visita_medica: '2026-09-20' },
  { id: 'c008', nome: 'Federico', cognome: 'Rosa', data_nascita: '2010-08-30', numero_maglia: 8, ruolo: 'Centrocampista', stato: 'Attivo', presenze: 12, gol: 2, assist: 2, tipo_documento: 'Passaporto', numero_documento: 'PA8901234', rilasciato_da: 'Questura di Roma', matricola_figc: 'FIGC-008-2024', data_visita_medica: '2026-10-05' },
  { id: 'c009', nome: 'Tommaso', cognome: 'Viola', data_nascita: '2010-09-12', numero_maglia: 9, ruolo: 'Attaccante', stato: 'Attivo', presenze: 11, gol: 7, assist: 3, tipo_documento: 'Carta Identità', numero_documento: 'AB9012345', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-009-2024', data_visita_medica: '2026-11-12' },
  { id: 'c010', nome: 'Nicolò', cognome: 'Grigi', data_nascita: '2010-11-03', numero_maglia: 10, ruolo: 'Centrocampista', stato: 'Attivo', presenze: 9, gol: 1, assist: 2, tipo_documento: 'Carta Identità', numero_documento: 'AB0123456', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-010-2024', data_visita_medica: '2026-12-01' },
  { id: 'c011', nome: 'Giovanni', cognome: 'Marroni', data_nascita: '2010-12-18', numero_maglia: 11, ruolo: 'Attaccante', stato: 'Attivo', presenze: 12, gol: 12, assist: 6, tipo_documento: 'Carta Identità', numero_documento: 'AB1234568', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-011-2024', data_visita_medica: '2027-01-10' },
  { id: 'c012', nome: 'Riccardo', cognome: 'Celesti', data_nascita: '2010-03-25', numero_maglia: 12, ruolo: 'Portiere', stato: 'Attivo', presenze: 4, gol: 0, assist: 0, tipo_documento: 'Carta Identità', numero_documento: 'AB2345679', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-012-2024', data_visita_medica: '2027-02-15' },
  { id: 'c013', nome: 'Filippo', cognome: 'Oro', data_nascita: '2010-01-08', numero_maglia: 13, ruolo: 'Difensore', stato: 'Attivo', presenze: 8, gol: 0, assist: 1, tipo_documento: 'Passaporto', numero_documento: 'PA3456790', rilasciato_da: 'Questura di Roma', matricola_figc: 'FIGC-013-2024', data_visita_medica: '2027-03-01' },
  { id: 'c014', nome: 'Edoardo', cognome: 'Argento', data_nascita: '2010-05-30', numero_maglia: 14, ruolo: 'Centrocampista', stato: 'Attivo', presenze: 6, gol: 0, assist: 0, tipo_documento: 'Carta Identità', numero_documento: 'AB4567891', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-014-2024', data_visita_medica: '2026-08-10' },
  { id: 'c015', nome: 'Gabriele', cognome: 'Bronzo', data_nascita: '2010-07-11', numero_maglia: 15, ruolo: 'Difensore', stato: 'Attivo', presenze: 5, gol: 0, assist: 0, tipo_documento: 'Carta Identità', numero_documento: 'AB5678902', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-015-2024', data_visita_medica: '2027-01-20' },
  { id: 'c016', nome: 'Lorenzo', cognome: 'Rame', data_nascita: '2010-02-14', numero_maglia: 16, ruolo: 'Portiere', stato: 'Attivo', presenze: 0, gol: 0, assist: 0, tipo_documento: 'Carta Identità', numero_documento: 'AB6789013', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-016-2024', data_visita_medica: '2027-04-05' },
  { id: 'c017', nome: 'Niccolò', cognome: 'Piombo', data_nascita: '2010-10-07', numero_maglia: 17, ruolo: 'Attaccante', stato: 'Attivo', presenze: 10, gol: 5, assist: 2, tipo_documento: 'Carta Identità', numero_documento: 'AB7890124', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-017-2024', data_visita_medica: '2027-05-10' },
  { id: 'c018', nome: 'Samuele', cognome: 'Zinco', data_nascita: '2010-04-28', numero_maglia: 18, ruolo: 'Centrocampista', stato: 'Attivo', presenze: 7, gol: 0, assist: 1, tipo_documento: 'Carta Identità', numero_documento: 'AB8901235', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-018-2024', data_visita_medica: '2027-06-01' },
  { id: 'c019', nome: 'Antonio', cognome: 'Stagno', data_nascita: '2010-06-16', numero_maglia: 19, ruolo: 'Difensore', stato: 'Infortunato', presenze: 3, gol: 0, assist: 0, tipo_documento: 'Carta Identità', numero_documento: 'AB9012346', rilasciato_da: 'Comune di Roma', matricola_figc: 'FIGC-019-2024', data_visita_medica: '2026-11-30' },
  { id: 'c020', nome: 'Marco', cognome: 'Marea', data_nascita: '2010-08-03', numero_maglia: 20, ruolo: 'Attaccante', stato: 'Attivo', presenze: 8, gol: 3, assist: 1, tipo_documento: 'Passaporto', numero_documento: 'PA0123457', rilasciato_da: 'Questura di Roma', matricola_figc: 'FIGC-020-2024', data_visita_medica: '2027-02-28' }
];
